...
- `{{endpoint_policy_json}}`：`resources/agent_soft_layer/endpoint_policy.json`。
- `{{source_manifest_path}}`：`resources/agent_market_context/binance/provenance.manifest.json`。
