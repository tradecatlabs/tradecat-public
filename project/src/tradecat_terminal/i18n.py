...
MESSAGES: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "empty_cache_plain": "暂无本地快照缓存，请执行：tradecat sync signal_flow 或 tradecat",
        ...
        "empty_cache_weak_network_hint": "弱网可执行：tradecat config set tui_fetch_timeout.signal_flow 3",
        "mode_live": "实时",
        "mode_history": "历史",
        "controls": (
    ...
    "en": {
        ...
        "cache_label": "cache",
        "current_label": "current",
        "empty_cache_plain": "No local snapshot cache. Run: tradecat sync signal_flow or tradecat",
        ...
        "empty_cache_weak_network_hint": "On weak networks, run: tradecat config set tui_fetch_timeout.signal_flow 3",
        "mode_live": "live",
    ...
    "ko": {
        ...
        "cache_label": "cache",
        "current_label": "current",
        "empty_cache_plain": "로컬 스냅샷 캐시가 없습니다. 실행: tradecat sync signal_flow 또는 tradecat",
        ...
        "empty_cache_weak_network_hint": "느린 네트워크에서는 실행: tradecat config set tui_fetch_timeout.signal_flow 3",
        "mode_live": "실시간",
        "mode_history": "히스토리",
        "controls": (
