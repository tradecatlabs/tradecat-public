...
RESOURCE_ROOT_CONTRACT_PATH = "project/resources/agent_soft_layer"
...
def build_agent_soft_layer_bundle(*, include_prompt_text: bool = True) -> dict[str, Any]:
    ...
    return {
        ...
        "provenance": {
            "binance_source_manifest": "project/resources/agent_market_context/binance/provenance.manifest.json",
