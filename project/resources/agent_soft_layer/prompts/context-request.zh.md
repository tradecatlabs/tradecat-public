...
- `{{endpoint_policy_json}}`：`project/resources/agent_soft_layer/endpoint_policy.json`。
- `{{source_manifest_path}}`：`project/resources/agent_market_context/binance/provenance.manifest.json`。
