...
def test_soft_layer_bundle_is_self_contained_and_prompt_oriented() -> None:
    ...
    assert bundle["resource_root"] == "project/resources/agent_soft_layer"
...
def test_soft_layer_bundle_exposes_configurable_trader_role_profile() -> None:
    ...
    assert trader["path"] == "project/resources/agent_soft_layer/profiles/discretionary-futures-trader.zh.md"
