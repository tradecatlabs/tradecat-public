...
-> Node 1: installer parses install dir, bin dir, repository, branch, project subdir, and Python version environment variables
-> Node 2: installer clones or updates the configured repository and branch
...
-> Node 5: installer writes `tradecat` and `tcat` launchers with throttled background update and force-update support
