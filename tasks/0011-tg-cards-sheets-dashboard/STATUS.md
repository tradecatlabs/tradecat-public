...
- 远端：`nvidia@100.91.176.84`（repo：`~/.projects/tradecat`，legacy services 布局）
- 远端服务：`~/.projects/tradecat/services/sheets-service`
- Evidence commands:
  - `ssh -i /home/lenovo/.ssh/tradecat_nvidia nvidia@100.91.176.84 'cd ~/.projects/tradecat/services/sheets-service && ./scripts/start.sh status'`
  - `ssh -i /home/lenovo/.ssh/tradecat_nvidia nvidia@100.91.176.84 'cat ~/.projects/tradecat/services/sheets-service/data/checkpoint.json && wc -l ~/.projects/tradecat/services/sheets-service/data/outbox.jsonl'`
