...
bash scripts/run-tradecat.sh run-context --input "$TMP_DIR/agent-context.json" --mode paper --agent-margin-usdt 7.5 --paper-leverage 3.0 --json >"$TMP_DIR/run-context.json"
