...
```text
src/tradecat_terminal/dataset_consumption_contract.json
```

Formal schema:

```text
contracts/tradecat-dataset-consumption-contract.schema.json
```
...
- this reference and `skills/tradecat-public/agents/manifest.json`
