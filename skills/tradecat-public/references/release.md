...
- Adds the formal `tradecat.watch_status.v1` watcher lifecycle contract for
  `scripts/start.sh --json` status/start/stop output.
...
```bash
tradecat-uninstall
curl -fsSL https://raw.githubusercontent.com/tukuaiai/tradecat/v0.1.2/install.sh | TRADECAT_INSTALL_REF=v0.1.2 sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/tukuaiai/tradecat/v0.1.2/install.sh | sh
```

Windows PowerShell:

```powershell
irm https://raw.githubusercontent.com/tukuaiai/tradecat/v0.1.2/install.ps1 | iex
```
...
```bash
tradecat-uninstall
curl -fsSL https://raw.githubusercontent.com/tukuaiai/tradecat/v0.1.1/install.sh | TRADECAT_INSTALL_REF=v0.1.1 sh
```
...
```powershell
$env:TRADECAT_INSTALL_REF = "v0.1.1"; irm https://raw.githubusercontent.com/tukuaiai/tradecat/v0.1.1/install.ps1 | iex
```
...
```bash
tradecat-uninstall
curl -fsSL https://raw.githubusercontent.com/tukuaiai/tradecat/v0.1.0/install.sh | TRADECAT_INSTALL_REF=v0.1.0 sh
```
...
```powershell
$env:TRADECAT_INSTALL_REF = "v0.1.0"; irm https://raw.githubusercontent.com/tukuaiai/tradecat/v0.1.0/install.ps1 | iex
```

Highlights:

- Standard Skill wrapper with all project source at the repository root.
